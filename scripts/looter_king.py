...
class LooterKing(ScriptStrategyBase):
    ...
    def format_status(self) -> str:
        ...
        closed_by_early_loot_global = 0
        closed_by_stop_loss_global = 0
        closed_by_time_limit_global = 0
        closed_by_loot_global = 0
        canceled_by_time_limit_global = 0
        lines = []
        for trading_pair, roulette_info in self.roulette_by_trading_pair.items():
            ...
            closed_by_early_loot_global += closed_by_early_loot
            closed_by_stop_loss_global += closed_by_stop_loss
            closed_by_time_limit_global += closed_by_time_limit
            closed_by_loot_global += closed_by_loot
            canceled_by_time_limit_global += canceled_by_time_limit
...
|Max Stop Loss: {max_stop_loss:.4f}
...
Loots: {closed_by_loot_global}
Early loots: {closed_by_early_loot_global}
Stop Loss: {closed_by_stop_loss_global}
Time Limit: {closed_by_time_limit_global}
Expired: {canceled_by_time_limit_global}
"""])
        return "\n".join(lines)
