...
RUN ln -s /conf /home/hummingbot/conf && \
  ...
  ln -s /models /home/hummingbot/models && \
  ln -s /data /home/hummingbot/data && \
  ln -s /pmm_scripts /home/hummingbot/pmm_scripts && \
  ln -s /scripts /home/hummingbot/scripts

# Create mount points
RUN mkdir -p /conf /logs /data /pmm_scripts /scripts /gateway-conf /certs /models && \
  chown -R hummingbot:hummingbot /conf /logs /data /pmm_scripts /scripts /gateway-conf /certs /models
VOLUME /conf /logs /data /pmm_scripts /scripts /gateway-conf /certs /models
